...
#+latex: \author[First]{Erika Elizabeth Rodríguez Torres\corref{cor1}\fnref{label2}}
#+latex: \ead{erikart@uaeh.edu.mx}
#+latex: 
#+latex: \author[Second]{Margarita Tetlalmatzi Montiel}
#+latex: \ead{tmontiel@uaeh.edu.mx}
#+latex: 
#+latex: \author[Third]{Rafael Villarroel Flores}
#+latex: \ead{rafaelv@uaeh.edu.mx}
#+latex: 
#+latex: \fntext[label2]{Nota al pie para el autor 1}
#+latex: \cortext[cor1]{Autor en correspondencia.}
#+latex: 
#+latex: \address{Área Académica de Matemáticas y Física, Universidad Autónoma del Estado de Hidalgo, Carretera Pachuca-Tulancingo Km. 4.5, Col. Carboneras, C. P. 42184, Mineral de la Reforma, Hgo., México}
# #+latex: \address[Second]{Área Académica de Matemáticas y Física, UAEH}
# #+latex: \address[Third]{Área Académica de Matemáticas y Física, UAEH}
#+end_frontmatter
