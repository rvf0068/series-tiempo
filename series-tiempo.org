...
plt.show()
   ...
   #+RESULTS[be79af661cdf688e66b37dd46c6ba431b8b21648]: barras-adyacentes
...
plt.show()
   ...
   #+RESULTS[4a036353c38a94c49b70f5816af86bc1f51994c5]: barras-no-adyacentes
...
plt.show()
   ...
   #+name: graficav01
   #+BEGIN_SRC ipython :session :ipyfile ./graficav01.png :exports both :results raw
import matplotlib.pyplot as plt
import networkx as nx
